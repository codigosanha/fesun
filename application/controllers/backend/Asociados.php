	...
	public function importar(){
		...
		foreach($object->getWorksheetIterator() as $worksheet)
		{
			...
			for($row=2; $row<=$highestRow; $row++)
			{
				...
				$vinculado_fondo = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$nombre_entidad = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$poblacion_vulnerable = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$tipo_poblacion = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$otra_poblacion = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$maneja_recursos = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$reconocimiento = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$poder_publico = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$tiene_familiares = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$especificacion = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$familiares_asociados = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$primer_apellido_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$segundo_apellido_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$nombres_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$tipo_identificacion_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$num_identificacion_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$fec_nacimiento_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$actividad_laboral_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$salario_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$jornada_laboral_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$empresa_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$cargo_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$antiguedad_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$telefono_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$celular_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$nivel_escolar_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$ocupacion_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				$asociado_fesun_conyuge = $worksheet->getCellByColumnAndRow(30, $row)->getValue();
				...
				$observaciones_laboral = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$ingreso_bruto = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$otros_ingresos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$descripcion_ingresos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$total_ingresos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$prestamos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$gastos_familiares = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$otros_gastos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$total_egresos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$bancos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$corporaciones = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$personales = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$total_obligaciones = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$activos_propiedades = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$pasivos_obligaciones = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$cuenta_bancaria = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$entidad = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$tipo_cuenta = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$operaciones_extranjeras = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$pais = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$moneda_extranjera = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$banco = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$cuenta = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$declara_renta = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$marca = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$modelo = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$placa = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$valor = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$pignoracion = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$entidad_pignorado = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$tipo_bien = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$direccion = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$departamento_bienes = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$ciudad_bienes = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$valor_comercial = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$matricula_inmobilaria = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$hipoteca = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$entidad_hipotecada = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$otros_activos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$prf_nombres_apellidos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$prf_parentesco = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$prf_telefono = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$prf_celular = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$srf_nombres_apellidos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$srf_parentesco = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$srf_telefono = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$srf_celular = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$rc_nombres_apellidos = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$rc_parentesco = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$rc_telefono = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$rc_celular = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$tipo_vinculacion = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$fec_diligencia = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$oficina = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$fecha_afiliacion = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$interes = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$lugar_entrevista = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$fecha_entrevista = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$hora = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$usuario_id = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$observaciones_diligencia = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$estado = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
				$user_aprueba = $worksheet->getCellByColumnAndRow(40, $row)->getValue();
