<section class="content-header">
    <h1>
        Asociados <small> Impresión</small>
    </h1>
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-12 text-right">
					<button type="button" class="btn btn-primary btn-flat btn-print-asociado"><span class="fa fa-print"></span> Imprimir</button>
				</div>
			</div>
			<br>
						...
						<tbody>
							<tr>
								<td class="text-center" style="font-size: 8px;">
									<img src="<?php echo base_url();?>assets/images/logo.png" style="height: 40px; margin: 0 auto;" class="img-responsive" alt=""> 
...
Declaro que la totalidad de pagos que realizo a FESUN se efectúa de forma directa y con los recursos propios y no a través de terceros ni con recursos de terceros.
			...
			<div class="row">
				<div class="col-md-12">
					<?php if ($asociado->estado == 0): ?>

					<button type="button" id="btnAprobarSolicitud" class="btn btn-success btn-flat btn-lg" value="<?php echo $asociado->id;?>">
						<span class="fa fa-check"></span> Aprobar
					</button>
					<button type="button" id="btnDesaprobarSolicitud" class="btn btn-danger btn-flat btn-lg" value="<?php echo $asociado->id;?>">
						<span class="fa fa-times"></span> No Aprobar
					</button>
					<?php endif ?>
				</div>
			</div>
